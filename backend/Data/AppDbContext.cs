...
using backend.Models.Domain.Views;
...
namespace backend.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<VwActiveCustomer> VwActiveCustomers => Set<VwActiveCustomer>();
        public DbSet<VwMonthlySalesSummary> VwMonthlySalesSummaries => Set<VwMonthlySalesSummary>();
        public DbSet<VwProductInventoryStatus> VwProductInventoryStatuses => Set<VwProductInventoryStatus>();
        public DbSet<VwSupplierPerformance> VwSupplierPerformances => Set<VwSupplierPerformance>();
        public DbSet<VwTopProductsByRevenue> VwTopProductsByRevenues => Set<VwTopProductsByRevenue>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ─── Views ─────────────────────────────────────
            modelBuilder.Entity<VwActiveCustomer>().HasNoKey().ToView("vw_ActiveCustomers");
            modelBuilder.Entity<VwMonthlySalesSummary>().HasNoKey().ToView("vw_MonthlySalesSummary");
            modelBuilder.Entity<VwProductInventoryStatus>().HasNoKey().ToView("vw_ProductInventoryStatus");
            modelBuilder.Entity<VwSupplierPerformance>().HasNoKey().ToView("vw_SupplierPerformance");
            modelBuilder.Entity<VwTopProductsByRevenue>().HasNoKey().ToView("vw_TopProductsByRevenue");
        }
    }
}
